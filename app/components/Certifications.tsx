      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <motion.span
            ...
            className="inline-block text-sm font-semibold tracking-[0.3em] text-purple-400 uppercase mb-4"
          >
            — Achievements —
          </motion.span>
...
<div className="text-4xl">📜</div>
              ...
              {/* Title + Issuer */}
              <h3 className="text-base font-bold text-white mb-1 group-hover:text-purple-300 transition-colors leading-snug flex-1">
                {cert.title}
              </h3>
              <p className="text-gray-400 text-sm mb-4 leading-snug">{cert.issuer}</p>
              ...
              <div className="absolute inset-0 rounded-2xl flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/10 transition-opacity duration-300 pointer-events-none">
        ...
        {selectedCert && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative z-10 w-full max-w-3xl bg-gray-900 border border-white/10 rounded-3xl overflow-hidden shadow-2xl"
            >
              {/* Modal Header */}
              <div
...
<span className="text-3xl">🎓</span>
                ...
                <button
                  onClick={() => setSelectedCert(null)}
                  className="p-2 rounded-full bg-white/10 hover:bg-white/20 transition-colors text-white shrink-0 ml-4"
                >
              ...
              {/* Certificate Image */}
              <div className="relative w-full bg-gray-950" style={{ minHeight: "420px" }}>
                <Image
              ...
              {/* Modal Footer */}
              <div className="p-4 border-t border-white/10 flex items-center justify-between bg-gray-900/50">
                <span className={`text-xs font-semibold px-3 py-1 rounded-full ${selectedCert.badge}`}>
