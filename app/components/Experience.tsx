...
export default function Experience() {
  return (
    <section className="px-6 md:px-10 py-24 border-t border-gray-800 relative overflow-hidden">

      {/* Ambient glows */}
      <div className="absolute w-[400px] h-[400px] bg-blue-500 blur-[120px] opacity-10 top-20 left-20 pointer-events-none" />
      <div className="absolute w-[300px] h-[300px] bg-cyan-500 blur-[130px] opacity-10 bottom-10 right-10 pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="mb-14"
        >
          <span className="inline-block text-sm font-semibold tracking-[0.3em] text-cyan-400/70 uppercase mb-3">
            — Career Journey —
          </span>
          <h2 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-600 bg-clip-text text-transparent">
            Experience
          </h2>
        </motion.div>
        ...
        >
          ...
          ">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
              <div>
                <div className="flex items-center gap-3 mb-1">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/30 flex items-center justify-center text-lg">
                    🏢
                  </div>
                ...
                <p className="text-cyan-400 font-medium mt-1 ml-[52px]">
            ...
            <p className="text-gray-500 text-sm mt-3 ml-[52px]">
              Hybrid · Bengaluru, India
            </p>

            {/* divider */}
            <div className="h-px w-full bg-gradient-to-r from-gray-700/60 via-gray-700/20 to-transparent my-7" />
            ...
            <ul className="space-y-4">
              {highlights.map((h, i) => (
                ...
                >
                  <span className="mt-1 flex-shrink-0 w-5 h-5 rounded-full bg-cyan-500/15 border border-cyan-500/40 flex items-center justify-center">
                    <svg className="w-3 h-3 text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                    </svg>
                  </span>
                  <span className="text-gray-300 leading-7 group-hover:text-gray-100 transition-colors">
                    {h.text}
                  </span>
                </motion.li>
              ))}
